...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    List<Order> findByUserIdAndOrderStatusAndShipperDeliveredAndShipperDeliveredAtBefore(Long userId, OrderStatus orderStatus, Boolean shipperDelivered, LocalDateTime threshold);
